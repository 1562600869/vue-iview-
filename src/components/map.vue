<template>
  <baidu-map class="bm-view" id="mymap" :center="{lng: 116.404, lat: 39.915}" :zoom="15" :scroll-wheel-zoom="true">
    <bm-marker :position="markerPoint" :dragging="true" animation="BMAP_ANIMATION_BOUNCE" @mouseout="infoWindowClose" @mouseover="infoWindowOpen"  size: {width: 300, height: 157}}">
